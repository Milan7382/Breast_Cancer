...
def add_predictions(input_data):
    ...
    if prediction[0] == 0:
        ...
        st.write("Malicious")
    st.write("Probability of being a Benign: ", model.predict_proba(input_array_scaled)[0][0])
    st.write("Probability of being a Malicious: ", model.predict_proba(input_array_scaled)[0][1])
...
def main():
    ...
    with st.container():
        ...
        st.write("Connect this app to your lab to help diagnose breast cancer")
